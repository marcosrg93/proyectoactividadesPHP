...
class DataBase {
    ...
    // function send2($sql,$condicion="") {
    //     $this->consulta = $this->conexion->prepare($sql);
    //     $r = $this->consulta->execute();
    //     if ($this->depurando === true) {
    //         $this->seeError($sql, $condicion, $r);
    //     }
    //     return $r;
    // }
    ...
    function getCursorSearch($tabla, $proyeccion = '*', $condicion = '', $busqueda, $orderby = '1', $limit = '') {
    ...
    function getCursorPara($tabla, $proyeccion = '*', $condicion = '', $busqueda, $orderby = '1', $limit = '') {
        return $this->getCursorSearch($tabla, $proyeccion , $condicion , $busqueda, $orderby , $limit);
    }
}